...
| v3 | Segundo motor (**SQL Server**) — nace la fábrica de repositorios real | Sin especificar |
...
> tabla sin conocerla de antemano. Y la v6 le pone encima un front Flask (Jinja2)
